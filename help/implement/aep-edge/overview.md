...
| Neither `web.webInteraction.type` nor `webPageDetails.name` nore `web.webPageDetails.URL` | will be recorded in Analytics but will not register as a pageview or link event |
